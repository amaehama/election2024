...
- STEM活動に触れられる新世代児童館の設置
    - 児童館等、子どもの放課後施設でSTEM（科学（Science）、技術（Technology）、工学（Engineering）、数学（Mathematics））活動に触れられるようなハード（3Dプリンターなど）・ソフト（コンテンツ・スタッフ）を整備し児童生徒がテクノロジーに触れられる環境を作る。
...
- STEM活動に触れられるハードを設置し、企業連携から良質なコンテンツを集めていく
...
## STEMへの就職・進路にはいまだにジェンダーバイアスが強く働いている
